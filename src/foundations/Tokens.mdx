...
<ColorTable rows={[
  ["brand.solid", "#12a594", "#61d1c4", "Primary solid fill (dark: lighter/desaturated)"],
  ...
  ["brand.onSolid", "#ffffff", "#18181b", "Foreground on a brand/solid fill (dark: dark text)"],
]} />
...
- `family.sans` (Pretendard stack — load Pretendard in your app; see `docs/tokens.md`), `family.mono` (Geist Mono stack)
